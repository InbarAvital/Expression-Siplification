...
public class Sin extends UnaryExpression implements Expression {
    ...
    public double evaluate(Map<String, Double> assignment) throws Exception {
        Expression evaluatedSin = new Sin(e1.evaluate(assignment));
        return evaluatedSin.evaluate();
    }
    ...
    public double evaluate() throws Exception {
        return Math.sin(this.e1.evaluate());
    }
    ...
    public Expression differentiate(String var) {
        return new Mult(new Cos(this.e1), this.e1.differentiate(var));
    }
    /**
    ...
    public Expression simplify() {
        ...
        if (this.e1.getVariables().size() == 0) {
            try {
                return new Num(new Sin(e1.simplify()).evaluate());
            } catch (Exception e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
        }
        return new Sin(this.e1.simplify());
    }
    /**
    ...
    public Expression bonusSimplify() {
        ...
        if (m1.getClass() == Neg.class) {
            return new Neg(new Sin(m1.getE1())).bonusSimplify();
        }
        return new Sin(m1).simplify();
    }
}
